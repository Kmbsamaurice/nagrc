...
<section class="header-inner">
					...
					<div class="row-slider">
						...
						<div class="col-lg-6 ">
							<div class="company mar-left10">
								<h4 style="color: rgb(56, 18, 56);">Live Stock Experimentation Station(LES)</h4>
 ...
 <section class="Sub-header">
    ...
    <div class="bg"></div>
    <p style="padding-top: 80px;">Sanga Field Station</p>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="row-slider">
						...
						<div class="col-lg-6 ">
							<div class="company mar-left10">
								<h4 style="color: rgb(56, 18, 56);">Sanga Field Station</h4>
								<p>Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce dapibus, tellus ac cursus etiam porta sem malesuada magna mollis euismod. commodo, Faccibus mollis interdum. Morbi leo risus, porta ac, vestibulum at eros.
								  Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce dapibus, tellus ac.</p>
							</div>
  ...
  <section class="Sub-header">
    ...
    <div class="bg"></div>
    <p style="padding-top: 80px;">Bulago Stock Farm</p>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="row-slider">
						...
						<div class="col-lg-6 ">
							<div class="company mar-left10">
								<h4 style="color: rgb(56, 18, 56);">Bulago Stock Farm</h4>
								<p>Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce dapibus, tellus ac cursus etiam porta sem malesuada magna mollis euismod. commodo, Faccibus mollis interdum. Morbi leo risus, porta ac, vestibulum at eros.
								  Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce dapibus, tellus ac.</p>
							</div>
...
<section class="Sub-head">
    ...
    <div class="bg2"></div>
    <p style="padding-top: 80px;"><a href="farms2.php"><button type="submit" class="line-btn">NEXT</button></a></p>
