...
<section class="header-inner">
    ...
    <div class="bg"></div>
    <p style="padding-top: 80px;">Research</p>
					...
					<div class="row-slider">
						...
						<div class="col-lg-6 ">
							<div class="company mar-left10">
								<h4 style="color: rgb(56, 18, 56);">ARTIFICIAL INSEMINATION PROCESS</h4>
...
<section class="Sub-header">
    ...
    <div class="bg"></div>
    <p style="padding-top: 80px;">LIQUID NITROGEN PRESENTATION</p>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="row-slider">
						...
						<div class="col-lg-6 ">
							<div class="company mar-left10">
								<h4 style="color: rgb(56, 18, 56);">LIQUID NITROGEN PRESENTATION</h4>
								<p>Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce dapibus, tellus ac cursus etiam porta sem malesuada magna mollis euismod. commodo, Faccibus mollis interdum. Morbi leo risus, porta ac, vestibulum at eros.
								  Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce dapibus, tellus ac.</p>
 ...
 <section class="Sub-header">
    ...
    <div class="bg"></div>
    <p style="padding-top: 80px;">NON-PREGNANCY DIAGNOSIS PROCESS</p>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="row-slider">
						...
						<div class="col-lg-6 ">
							<div class="company mar-left10">
								<h4 style="color: rgb(56, 18, 56);">NON-PREGNANCY DIAGNOSIS PROCESS</h4>
								<p>Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce dapibus, tellus ac cursus etiam porta sem malesuada magna mollis euismod. commodo, Faccibus mollis interdum. Morbi leo risus, porta ac, vestibulum at eros.
								  Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce dapibus, tellus ac.</p>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="row-slider">
						<div class="col-lg-6 ">
							<div class="company mar-left10">
								<h4 style="color: rgb(56, 18, 56);">MULTI OVULATION AND EMBRYO TRANSFER</h4>
								<p>Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce dapibus, tellus ac cursus etiam porta sem malesuada magna mollis euismod. commodo, Faccibus mollis interdum. Morbi leo risus, porta ac, vestibulum at eros.
								  Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce dapibus, tellus ac.</p>
